...
const ROUTES = {
  ...
  defaultAdminUserUrl: '/admin/users/golden_ks_a_member_2?tenantId=tenant_ks',
...
const SELECTORS = {
  ...
  memberDocumentsReady: '[data-testid="member-documents-page-ready"]',
  memberDocumentsEmptyState: '[data-testid="member-documents-empty-state"]',
  memberDocumentsCreateClaim: '[data-testid="member-documents-create-claim"]',
