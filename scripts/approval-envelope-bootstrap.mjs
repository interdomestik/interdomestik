...
const plan = name => join(new URL('..', import.meta.url).pathname, 'docs/plans', name);
const CANONICAL = {
...
const RECEIPT_SHA = '25848169a0cec8c36991e76c6ff81b5d9c4fd8616d86b81740d497b2003221ab';
const ENVELOPE_BYTES = 50373;
const ENVELOPE_SHA = '9bf950e860b52b1f521ba323d1063146d69f1477db07cdf880ba4aef02eb6bb1';
