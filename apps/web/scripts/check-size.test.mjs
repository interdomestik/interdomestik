...
const localRow = {
  path: 'static/chunks/local.js',
  bytes: localBody.length,
  gzipBytes: gzipSync(localBody, { level: 9 }).length,
  sha256: sha(localBody),
};
...
function evidence(change = {}) { return { headSha: HEAD, deploymentSha: HEAD, previewOrigin: ORIGIN,
  ...
  deploymentRef: 'codex/ida-t115-od17-performance-proof', eventName: 'workflow_dispatch', headBranch: 'main',
