...
type InjuryEvidenceOutcomeProps = Readonly<{
  backLabel: string;
  body: string;
...
export function InjuryEvidenceOutcome(props: InjuryEvidenceOutcomeProps) {
  return (
    <div className="space-y-6">
      ...
      <p id="injury-handoff-explanation" className="text-base leading-7 text-[#334D5C]">
        {props.handoff}
      </p>
      <button
        type="button"
        aria-describedby="injury-handoff-explanation"
