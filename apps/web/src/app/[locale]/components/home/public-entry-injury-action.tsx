...
type PublicEntryInjuryActionProps = Readonly<{ label: string }>;

export function PublicEntryInjuryAction({ label }: PublicEntryInjuryActionProps) {
  return (
    <Link
      data-testid="public-entry-injury"
      href={PUBLIC_FREE_START_ANCHOR_HREF}
      onClick={() => dispatchPublicEntryIntent('injury')}
