...
type PropertyEvidenceOutcomeProps = Readonly<{
  backLabel: string;
  body: string;
...
export function PropertyEvidenceOutcome(props: PropertyEvidenceOutcomeProps) {
  return (
    <div className="space-y-6">
      ...
      <ul className="space-y-3 border-y border-[#B8C7C7] py-5 text-base leading-7">
        {[...props.items, ...props.guidance].map(item => (
      ...
      <p id="property-handoff-explanation" className="text-base leading-7 text-[#334D5C]">
        {props.handoff}
      </p>
      <button
        type="button"
        aria-describedby="property-handoff-explanation"
