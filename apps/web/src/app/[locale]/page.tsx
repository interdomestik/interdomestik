...
import { Shield, FileText, Users, MessageCircle, ArrowRight, CheckCircle } from 'lucide-react';
        ...
        <section className="relative py-20 lg:py-32 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg md:text-xl text-[hsl(var(--muted-500))] mb-8 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s' }}>
                        {t('subtitle')}
                    </p>
                    ...
                    <p className="mt-8 text-sm text-[hsl(var(--muted-400))] animate-fade-in" style={{ animationDelay: '0.3s' }}>
                        {t('trustedBy')}
                    </p>
                </div>
            </div>
...
function FeaturesSection() {
    ...
    const features = [
        {
            icon: FileText,
            title: t('claimManagement.title'),
            description: t('claimManagement.description'),
        },
        {
            icon: Users,
            title: t('professionalSupport.title'),
            description: t('professionalSupport.description'),
        },
        {
            icon: Shield,
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    {plans.map((plan, index) => (
                        <div
                            key={index}
                            className={`glass-card rounded-2xl p-6 relative card-lift ${plan.popular ? 'ring-2 ring-[hsl(var(--primary))]' : ''
                                }`}
                        >
                            {plan.popular && (
    ...
    return (
        <section className="py-20 brand-gradient">
            <div className="container mx-auto px-4 text-center">
                ...
                <Link href="/register">
                    <Button size="xl" variant="outline" className="bg-white text-[hsl(var(--primary))] hover:bg-white/90 border-white">
                        {t('cta')}
                        <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                </Link>
