...
import { Button, Skeleton } from '@interdomestik/ui';
import { ExternalLink } from 'lucide-react';
import { useTranslations } from 'next-intl';
import { useEffect, useState } from 'react';

import { OpsDrawer } from '@/components/ops';
...
export function ClaimPreviewDrawer({ claim, onClose }: ClaimPreviewDrawerProps) {
  ...
  return (
    <OpsDrawer
      ...
      title={claim?.code ?? ''}
      testId="claim-preview-drawer"
    >
      {isLoading ? (
        <div className="space-y-4" data-testid="preview-skeleton">
