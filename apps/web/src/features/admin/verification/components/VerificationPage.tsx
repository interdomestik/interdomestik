...
import { getPendingCashAttemptsAction } from '../actions/verification';
import { CashVerificationRequestDTO } from '../server/verification.core';
...
export default async function VerificationPage() {
  ...
  return (
    <div className="container py-8 space-y-8">
      ...
      <VerificationList initialLeads={leads} />
    </div>
  );
}
