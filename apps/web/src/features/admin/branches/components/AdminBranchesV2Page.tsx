...
import { CreateBranchDialog } from '@/app/[locale]/admin/branches/components/create-branch-dialog';

export async function AdminBranchesV2Page({ locale }: { locale: string }) {
