...
export async function StatsV2Page({ locale }: { locale: string }) {
...
function StatCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 text-center group hover:scale-105 transition-transform">
