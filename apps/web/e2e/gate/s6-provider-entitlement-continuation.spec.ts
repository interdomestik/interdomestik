...
test.describe('S6 provider-confirmed entitlement continuation', () => {
  test('a verified member can submit the saved first case only after signed Paddle activation', async ({
    browser,
  }, testInfo) => {
