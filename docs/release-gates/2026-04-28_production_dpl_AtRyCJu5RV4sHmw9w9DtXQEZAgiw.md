# Release Gate — production — 2026-04-28

## Deployment

- Environment: production
- Alias: https://www.interdomestik.com
- Deployment ID: dpl_AtRyCJu5RV4sHmw9w9DtXQEZAgiw
- Deployment URL: https://interdomestik-8ahswllvz-ecohub.vercel.app
...
- Generated at: 2026-04-28T10:37:38.146Z
...
- agent /member => member=true, agent=false, staff=false, admin=false
...
- attempt=1 route=https://www.interdomestik.com/en/admin/users/golden_ks_staff?tenantId=tenant_ks not-found-page=true user-roles-table=false
...
- target=https://www.interdomestik.com/en/admin/users/golden_ks_a_member_1
...
- Account used: agent
- URL(s): https://www.interdomestik.com/en/member | https://www.interdomestik.com/en/agent | https://www.interdomestik.com/en/staff | https://www.interdomestik.com/en/admin
- Expected markers: /member member=true; /agent agent=true; /staff staff=false; /admin admin=false
- Observed markers: https://www.interdomestik.com/en/member => member=true, agent=false, staff=false, admin=false, notFound=false, rolesTable=false || https://www.interdomestik.com/en/agent => member=true, agent=true, staff=false, admin=false, notFound=false, rolesTable=false || https://www.interdomestik.com/en/staff => member=false, agent=false, staff=false, admin=false, notFound=true, rolesTable=false || https://www.interdomestik.com/en/admin => member=false, agent=false, staff=false, admin=false, notFound=true, rolesTable=false
- Result: PASS

### S2 Mixed roles: member+staff

- Account used: staff
- URL(s): https://www.interdomestik.com/en/member | https://www.interdomestik.com/en/staff | https://www.interdomestik.com/en/agent | https://www.interdomestik.com/en/admin
- Expected markers: /member member=true; /staff staff=true; /agent agent=false; /admin admin=false
- Observed markers: https://www.interdomestik.com/en/member => member=true, agent=false, staff=true, admin=false, notFound=false, rolesTable=false || https://www.interdomestik.com/en/staff => member=true, agent=false, staff=true, admin=false, notFound=false, rolesTable=false || https://www.interdomestik.com/en/agent => member=false, agent=false, staff=false, admin=false, notFound=true, rolesTable=false || https://www.interdomestik.com/en/admin => member=false, agent=false, staff=false, admin=false, notFound=true, rolesTable=false
- Result: PASS

### S3 Agent elevation attempt -> admin resource

- Account used: agent
- URL(s): https://www.interdomestik.com/en/admin/users/golden_ks_staff
...
- Account used: staff
- URL(s): https://www.interdomestik.com/en/agent
...
- URL(s): https://www.interdomestik.com/en/admin/users/golden_mk_admin?tenantId=tenant_mk
...
- Account used: admin_ks
- URL(s): https://www.interdomestik.com/en/staff
...
- member_documents_url=https://www.interdomestik.com/en/member/documents
- member_documents_surface=[data-testid="member-documents-page-ready"]
- member documents claim card count=7
...
- member_documents_url_relogin=https://www.interdomestik.com/en/member/documents
...
- download response 200 observed=false
- download response statuses: none captured
...
- staff_login_url=about:blank
- staff_claims_list_url=https://www.interdomestik.com/en/staff/claims
- staff_claims_list_final_url=https://www.interdomestik.com/en/staff/claims
- staff_page_ready_on_list=true
- staff_list_visible_selector=[data-testid="staff-page-ready"]
- configured_staff_claim_source=invalid
- configured_staff_claim_reason=cross-origin
- configured_staff_claim_pathname_family=/en/staff/claims
- configured_staff_claim_rejected reason=cross-origin
- fallback_search_elapsed_ms=26
- fallback_link_count=20
- fallback_detail_url=https://www.interdomestik.com/en/staff/claims/p8Sssag7yDHh3sbnx79u4
- claim_source=staff_claims_list_fallback
- detail_target_source=list-discovery
- detail_target_url=https://www.interdomestik.com/en/staff/claims/p8Sssag7yDHh3sbnx79u4
- detail_url_after_open=https://www.interdomestik.com/en/staff/claims/p8Sssag7yDHh3sbnx79u4
- detail_bounced_to_login_after_open=false
- detail_not_found=false
- staff_page_ready_on_detail=true
- detail_visible_selector=[data-testid="staff-claim-detail-ready"]
- detail_url_after_refresh=https://www.interdomestik.com/en/staff/claims/p8Sssag7yDHh3sbnx79u4
- detail_bounced_to_login_after_refresh=false
- staff_page_ready_after_refresh=true
- refresh_visible_selector=[data-testid="staff-claim-detail-ready"]
...
- scenario=staff_unsigned_agreement account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_14 attempted=configured:https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_14 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement missing collection path missing"
- scenario=staff_signed_deduction account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_15 attempted=configured:https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_15 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement ready collection path ready"
- scenario=staff_payment_method_fallback account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_17 attempted=configured:https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_17 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement ready collection path ready"
- scenario=staff_invoice_fallback account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_16 attempted=configured:https://www.interdomestik.com/en/staff/claims/golden_ks_a_claim_16 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement ready collection path ready"
...
- deployment_ref=https://interdomestik-8ahswllvz-ecohub.vercel.app
