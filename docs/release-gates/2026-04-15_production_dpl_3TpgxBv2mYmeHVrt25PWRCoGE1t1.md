# Release Gate — production — 2026-04-15

## Deployment

- Environment: production
- Alias: https://interdomestik-web.vercel.app
- Deployment ID: dpl_3TpgxBv2mYmeHVrt25PWRCoGE1t1
- Deployment URL: https://interdomestik-71br6fccq-ecohub.vercel.app
...
- Generated at: 2026-04-15T20:21:17.164Z
...
- member_documents_url=https://interdomestik-web.vercel.app/en/member/documents
- member_documents_surface=[data-testid="member-documents-page-ready"]
- member documents claim card count=7
- member documents upload button count=7
- upload dialog opened=true
- upload file listed after submit=true
- after hard refresh listed=true
- member_documents_url_relogin=https://interdomestik-web.vercel.app/en/member/documents
...
- download response statuses: 200@https://interdomestik-web.vercel.app/api/documents/185f1c90-d06c-479f-8122-1cc587c01248/download
...
- staff_claims_list_final_url=https://interdomestik-web.vercel.app/en/staff/claims
- staff_page_ready_on_list=true
- staff_list_visible_selector=[data-testid="staff-page-ready"]
- configured_staff_claim_source=ignored-list
...
- fallback_search_elapsed_ms=9
- fallback_link_count=20
- fallback_detail_url=https://interdomestik-web.vercel.app/en/staff/claims/v_j-vY7lHgTBeYsWwW8Wl
- claim_source=staff_claims_list_fallback
- detail_target_source=list-discovery
- detail_target_url=https://interdomestik-web.vercel.app/en/staff/claims/v_j-vY7lHgTBeYsWwW8Wl
- detail_url_after_open=https://interdomestik-web.vercel.app/en/staff/claims/v_j-vY7lHgTBeYsWwW8Wl
...
- detail_url_after_refresh=https://interdomestik-web.vercel.app/en/staff/claims/v_j-vY7lHgTBeYsWwW8Wl
...
- scenario=staff_unsigned_agreement account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_14 attempted=configured:https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_14 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement missing collection path missing"
- scenario=staff_signed_deduction account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_15 attempted=configured:https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_15 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement ready collection path ready"
- scenario=staff_payment_method_fallback account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_17 attempted=configured:https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_17 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement ready collection path ready"
- scenario=staff_invoice_fallback account=staff missing_testids=none missing_prerequisites=none missing_phrases=none observed=staff-claim-detail-ready=true,staff-accepted-recovery-prerequisites=true,staff-escalation-agreement-summary=true,staff-success-fee-collection-summary=true source=configured final_url=https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_16 attempted=configured:https://interdomestik-web.vercel.app/en/staff/claims/golden_ks_a_claim_16 prerequisites="accepted recovery prerequisites accepted recovery cannot move into negotiation or court until both prerequisites are ready. agreement ready collection path ready"
...
- deployment_ref=https://interdomestik-71br6fccq-ecohub.vercel.app
