...
> Status: Archived current-program ledger through predecessor PR #1807. This file preserves
> historical scope and proof; it does not select current work. Use
> `docs/plans/current-program.md` for active authority.
