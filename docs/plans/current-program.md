...
68. Keep `R08` complete as the canonical ranked pilot-entry operator-flow slice so the pilot-entry command path is inspectable and repeatable across pre-launch, gate proof, launch-day verification, and daily logging before a live pilot is declared governable.
