...
byte-identical ledger uses +11,378 bytes: 7,597 for the named S5.d source/test/catalog allocation,
1,382 to extend the existing owner of the four `claims.json` catalogs, 84 for the existing E2E reuse
owner, and 2,315 for capacity-budget self-attribution. Derived category growth is 3,353 source, 4,305
