...
| -------: | --------------- | -------------- | ------------------------------------ |
|        1 | `T-117C` Tier 3 | CUTOVER closed | Repeat promotion PR `#1708` pending. |
