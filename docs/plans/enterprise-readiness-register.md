...
| Threat-model evidence        | `docs/plans/ent-tm01-threat-model-evidence-contract-2026-06-05.md`; `docs/plans/ent-tm02-initial-claim-uploads-threat-model-2026-06-05.md`; `docs/plans/ent-tm03-authenticated-claim-evidence-uploads-threat-model-2026-06-06.md`; `docs/plans/ent-tm04-document-signed-urls-and-downloads-threat-model-2026-06-06.md`; `docs/plans/ent-tm05-share-packs-threat-model-2026-06-06.md`; `docs/plans/ent-tm06-ai-run-read-and-review-threat-model-2026-06-06.md` | Upload, document-access, share-pack, and AI review surfaces modeled |
...
| Threat model                 | Evidence contract scoped; initial uploads, authenticated uploads, document access, share packs, and AI review modeled | Written per-surface model for registration, uploads, documents, share packs, billing, AI review, and webhooks |
...
`ENT-TM06 AI Run Read And Review Threat Model`

Scope:

- Apply the `ENT-TM01` contract to AI run reads and human review submissions only.
- Model authenticated run reads, privileged review submissions, tenant-scoped run lookup,
  member-owner read restrictions, workflow-specific correction schema parsing, transactional
  review updates, STRIDE threats, residual risks, and verification evidence.
...
- The threat-model evidence contract is already defined by `ENT-TM01`, and `ENT-TM02` completed
  ...
  and `ENT-TM04` completed document signed URLs and downloads while `ENT-TM05` completed share
  packs.
- AI run read and review is the adjacent sensitive surface because it exposes persisted AI-derived
  extraction output and lets privileged reviewers approve, reject, or correct that output while
  staying bounded to current route/core/read-model proof files.
- Paddle webhooks are the next adjacent sensitive surface from the ownership map and should be
  modeled separately before registration and admin verification.
