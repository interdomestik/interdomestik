...
| Threat-model evidence        | `docs/plans/ent-tm01-threat-model-evidence-contract-2026-06-05.md`; `docs/plans/ent-tm02-initial-claim-uploads-threat-model-2026-06-05.md`; `docs/plans/ent-tm03-authenticated-claim-evidence-uploads-threat-model-2026-06-06.md`; `docs/plans/ent-tm04-document-signed-urls-and-downloads-threat-model-2026-06-06.md`; `docs/plans/ent-tm05-share-packs-threat-model-2026-06-06.md`; `docs/plans/ent-tm06-ai-run-read-and-review-threat-model-2026-06-06.md`; `docs/plans/ent-tm07-paddle-billing-webhooks-threat-model-2026-06-06.md` | Upload, document-access, share-pack, AI review, and Paddle webhook surfaces modeled |
...
| Threat model                 | Evidence contract scoped; initial uploads, authenticated uploads, document access, share packs, AI review, and Paddle webhooks modeled | Written per-surface model for registration, uploads, documents, share packs, AI review, billing, and webhooks |
...
`ENT-TM07 Paddle Billing Webhooks Threat Model`

Scope:

- Apply the `ENT-TM01` contract to Paddle billing webhook receipt, entity routing, and
  billing/audit persistence only.
- Model route rate limits, Paddle signature verification, entity-scoped config and secrets,
  unknown-entity rejection, tenant/entity mismatch preflight, scope-aware dedupe, invalid-signature
  audit, duplicate no-op handling, invoice/ledger invariants, STRIDE threats, residual risks, and
  verification evidence.
- Promote exactly one next bounded follow-up:
  `ENT-TM08 Assisted Registration Threat Model`.
- Do not change runtime code, schema, auth, tenancy, routing, billing, product UI, proxy,
  README, AGENTS, or broad architecture docs.
...
- The threat-model evidence contract is already defined by `ENT-TM01`; `ENT-TM02` through
  `ENT-TM06` completed upload custody, document access, share-pack, and AI review surfaces.
- Paddle webhooks are the adjacent sensitive billing surface because they cross public webhook
  receipt, provider signature validation, entity-specific configuration, tenant metadata, billing
  persistence, audit, and outbound side-effect boundaries.
- Assisted registration is the next smallest valuable sensitive-route model because it creates
  tenant-scoped users through an authenticated agent boundary and is listed separately in the route
  ownership map.
