...
The repository now has a typed AI boundary that remains off the request path. `AI02`, `AI03`, `AI04`, `AI05`, and `AI06` have since been promoted and completed in the live program and tracker.
