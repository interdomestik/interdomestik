...
| Member lifecycle/access disclosure | Candidate `S6-MEMBER-MEMBERSHIP-ACCESS-STATUS`                                                                                                                                       | IDA-MEM-008; IDA-MEM-009; IDA-MEM-012 | Bounded portal disclosure in progress; whole membership family and non-software acceptance remain open |
...
| IDA-MEM-008 | Lifecycle states | Canonical | unresolved | S6/S9 | S6 candidate renders the existing canonical lifecycle bucket and derives new-case access from the shared lifecycle contract; whole lifecycle/activation acceptance remains open | none | in-progress; candidate domain/UI/E2E proof pending protected receipt; Product + Engineering | U | U |
| IDA-MEM-009 | Grace and dunning | Target | unresolved | S6/S9 | S6 candidate distinguishes active-in-grace allowed access from grace-expired denied access and preserves existing truthful warning copy; provider dunning operations and business acceptance remain open | none | in-progress; candidate allowed/denied domain/UI/E2E proof pending protected receipt; Product + Engineering | U | U |
...
| IDA-MEM-012 | Member proof content | Canonical | unresolved | S6/S9 | S6 candidate discloses lifecycle status, current-period end when present and access consequence without provider, plan, price, score or quota metadata; broader member proof and acceptance remain open | none | in-progress; candidate projection/UI/locale proof pending protected receipt; Product + Engineering | U | U |
