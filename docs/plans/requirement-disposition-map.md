...
| IDA-DIA-002 | User-selected corridor | Canonical | unresolved | S5/S6; #1790 proves explicit guidance-country/no fallback; source `6d554972` captures strict origin/destination plus zero-to-12 ordered transit values over `CountryCodeSchema`; Trip Mode persistence/packs/handoff open | open | Tracker receipt; local full proof passes, protected delivery pending; exact source and receipt hashes are recorded in the tracker. | U | U | U |
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; source `6d554972` preserves guidance and corridor query values across actual EN/SQ/MK/SR changes; pack/content and non-software readiness open | open | Tracker receipt; local full proof passes, protected delivery pending | U | U | U |
