...
| IDA-MEM-006 | Provider confirmation | Target | unresolved | S6/S9; #1826 proves exact active Paddle status plus complete provider/member values and localized separate-case next steps; #1827 binds delivery to immutable tenant/member/subscription/event evidence; current candidate proves a verified member's saved draft stays blocked before and becomes submittable after a signed KS active-subscription event | open; verified provider event or reconciled authoritative transaction required; browser continuation and mail success grant no entitlement; approved offer/terms and live paid activation remain open | none | bounded #1826/#1827 delivered; current sandbox continuation candidate pending; whole acceptance open; Engineering | U | U |
| IDA-MEM-007 | Idempotent activation | Canonical | unresolved | S6/S9; #1824 proves exact retry/dedupe before entitlement writes, #1826 preserves duplicate receipt short-circuiting and #1827 adds immutable delivery CAS/retry; current candidate asserts exact event replay leaves one subscription, one lifecycle event and one exact-draft claim | open; existing wrong-tenant/entity, role, invalid-signature, failure, retry and concurrency contracts remain negative authority; offer/terms, live paid activation and whole acceptance remain unresolved | none | bounded #1824/#1826/#1827 delivered; current sandbox continuation candidate pending; whole acceptance open; Engineering | U | U |
