...
| S3 supported journey prefix | Current candidate from protected main 7db57a30c; `member-staff-evidence-journey.spec.ts`; protected PR pending                                                                       | IDA-CLM-001/014; IDA-CAS-005/006/007/008/015 | Submission → verification → member continuity only; IDA-CLM-010 request-bound upload/ack remains open |
...
| IDA-DIA-002 | User-selected corridor | Canonical | unresolved | S5/S6; see acceptance links | open | none | U | U | U |
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; see acceptance links | open | none | U | U | U |
...
| IDA-CAS-006 | Public/private intent | Canonical | pilot-required | S3/S6/S7/S13 | S3 candidate persists distinct public and private staff history on the exact claim and renders only the public note to the member; broader communication acceptance remains open | none | U | U | U |
...
| IDA-CAS-008 | Internal notes isolation | Target | pilot-required | S3/S6/S7/S13 | S3 candidate proves the private same-status staff note is absent from the exact returning member detail; other roles and surfaces remain open | none | U | U | U |
...
| IDA-CAS-015 | Domain event | Canonical | unresolved | S3/S6/S7/S13 | S3 candidate observes `case.created` and `claim.status_changed` for the exact claim; relay regression preserves Date/string timestamp forms and audit projection delivery. Broader event-family acceptance remains open | none | U | U | U |
