...
| IDA-DIA-002 | User-selected corridor | Canonical | unresolved | S5/S6; #1790 proves explicit guidance-country/no fallback only; bounded candidate captures strict origin/destination plus zero-to-12 ordered transit values over `CountryCodeSchema`; Trip Mode persistence/packs/handoff open | open | PR1790 + tracker receipt; successor +42,000 bytes/three files approved; full proof pending | U | U | U |
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; #1790 proves EN/SQ/MK/SR guidance-country independence; bounded candidate explicitly preserves corridor query values across actual locale changes; pack/content and non-software readiness open | open | PR1790 + tracker receipt; successor focused proof only | U | U | U |
