...
are safe no-ops, exact replay stays idempotent, and equal-time distinct or invalid evidence fails
permanently before side effects. Rows predating the marker derive a floor from verified receipts of
the exact entity processing scope. Entity-scoped `subscription.past_due` uses the same ordered write
on the exact existing provider row, and ordering precedes any confirmation claim. No
whole-requirement disposition changes; renewal/dunning operations beyond that event, approved
offer/terms and live provider evidence remain open; the unscoped legacy route is out of scope. #1829
(protected merge `5e69674`) credits first-activation reconciliation with the same-scope causal
`transaction.completed` receipt and exact-main automatic staging `36247906583` (unchanged-source
retry after a safe transient-network rollback; production skipped; no charge or provider mutation),
without offer comparison, whole S5/S6 or IDA-CTR-022/IDA-MEM-006/007 claims. #1824's
...
| Provider-order integrity           | PR #1829, 5e696747a7091e738b174830ec0a474f578af2fd                                                                                                                                   | IDA-CTR-022; IDA-MEM-006; IDA-MEM-007 | First-activation causal reconciliation credited; offer comparison and whole activation remain open         |
...
| IDA-CTX-002 | Neutral public gateway | Canonical | pilot-required | S5/S14 | protected PR #1803 exercises the organizer on an explicit neutral `ida.localhost` browser origin; whole gateway acceptance remains open | none | bounded #1803 delivered; whole gateway acceptance open; Engineering | U | U |
...
| IDA-CTX-004 | Proxy authority | Canonical | pilot-required | S5/S14 | protected PR #1803 keeps `proxy.ts` unchanged and exercises native browser requests through the existing authority without header rewriting or bypass; whole acceptance remains open | none | bounded #1803 delivered; whole acceptance open; Engineering | U | U |
...
| IDA-IAM-001 | Authentication boundary | Canonical | pilot-required | S1/S8/S11–S12 | protected PR #1803 adds a same-origin neutral OTP preflight before code consumption, then verifies through Better Auth and Supabase-backed identity/session boundaries with no bypass; whole authentication acceptance remains open | none | in-progress; native OTP/session E2E pending protected receipt; Engineering | U | U |
...
| IDA-IAM-010 | Member ownership | Target | pilot-required | S1/S8/S11–S12 | protected PR #1803 binds the saved draft to the freshly resolved verified member and returns `notFound` in a foreign tenant context; broader member ownership acceptance remains open | none | in-progress; owner/tenant E2E pending protected receipt; Engineering | U | U |
...
| IDA-FST-003 | No anonymous server identity | Canonical | unresolved | S5 | protected PR #1803 proves browser-only preparation and OTP delivery create neither a server account nor server draft before successful verification | none | bounded #1803 delivered; whole acceptance open; Engineering | U | U |
| IDA-FST-004 | Local disclosure | Target | unresolved | S5 | protected #1817 delivered prior EN/SQ/MK/SR disclosure with opt-in/no-save, eligible/excluded facts, expiry/deletion and secure save; exact-main #1821 CD #36088924719 passed staging | #1817 handoff; broader business/privacy acceptance retained | bounded staging-delivered; Product + Privacy | U | U |
...
| IDA-FST-008 | Verified secure save | Canonical | pilot-required | S5; password-authenticated promotion delivered in #1801; protected PR #1803 exercises cookie-free untrusted-origin refusal without code consumption, delivered email OTP, verified identity, fresh resolved owner and exact secure draft persistence | open | none | bounded #1803 delivered; whole acceptance open; Engineering | U | U |
| IDA-FST-009 | Delete after confirmed save | Canonical | unresolved | S5; protected PR #1803 proves the browser copy remains after refusal and is removed only after confirmed secure save | open | none | bounded #1803 delivered; whole acceptance open; Engineering | U | U |
| IDA-FST-010 | No automatic claim conversion | Canonical | unresolved | S5; #1801 proves explicit-submit conversion; protected PR #1803 additionally proves save/return/delete create no claim, subscription or CRM lead | open | none | bounded #1803 delivered; whole acceptance open; Engineering | U | U |
