...
| IDA-DIA-002 | User-selected corridor | Canonical | unresolved | S5/S6; #1790 proves explicit guidance-country/no fallback; #1792 source `757aa623` captures origin/destination and zero-to-12 ordered transit values over `CountryCodeSchema`; selected S5.e will disclose pack status from that explicit corridor only; persistence/handoff open | open | Tracker receipt; source `757aa623` full proof and exact-main `e8142453` health passed; S5.e product proof pending capacity authority. | U | U | U |
...
| IDA-DIA-004 | Signed pack requirement | Canonical | unresolved | S5/S6; selected S5.e may disclose only the existing Help Now exposure predicate and cannot claim current/versioned/integrity/expiry readiness; full contract remains a later direct dependency | open | MOB-01b/MK exposure receipt credited; S5.e product proof pending capacity authority | U | U | U |
| IDA-DIA-005 | Unsigned pack fail-closed | Canonical | unresolved | S5/S6; selected S5.e keeps dark, unaccepted, unsigned and unregistered corridor entries unavailable without fallback; expired/withdrawn/integrity-failed contracts remain open | open | S5.e product proof pending capacity authority | U | U | U |
