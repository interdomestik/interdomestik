...
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; #1792 source `757aa623` preserves guidance/corridor query values across EN/SQ/MK/SR locale changes; S5.e source `05bcd02d` proves equivalent locale-independent pack-status disclosure; pack/content and non-software readiness open | open | Tracker receipt; source/tree/E2E tree `05bcd02d`/`88e68c1f`/`c96665e7` passed full local product and security proof; protected delivery pending. | U | U | U |
...
| IDA-DIA-005 | Unsigned pack fail-closed | Canonical | unresolved | S5/S6; S5.e keeps dark, unaccepted, unsigned and unregistered corridor entries unavailable without fallback; expired/withdrawn/integrity-failed contracts remain open | open | S5.e source/tree/E2E tree `05bcd02d`/`88e68c1f`/`c96665e7` passed full local fail-closed product and security proof; protected delivery pending. | U | U | U |
