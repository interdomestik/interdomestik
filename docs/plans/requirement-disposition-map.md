...
| IDA-MEM-006 | Provider confirmation | Target | unresolved | S6/S9; direct dependency for newly verified S5 first-case submission; active confirmation-safety candidate requires exact active Paddle status plus complete provider/member values and localized separate-case next steps | open; verified provider event or reconciled authoritative transaction required; browser continuation grants no entitlement; current candidate does not establish immutable delivery or whole activation | none | U | U | U |
| IDA-MEM-007 | Idempotent activation | Canonical | unresolved | S6/S9; #1824 proves exact retry/dedupe before entitlement writes; current confirmation-safety candidate preserves duplicate receipt short-circuiting and disables unsnapshotted resend | open; immutable confirmation/delivery snapshot and safe mail retry/resend remain unresolved | none | bounded #1824 delivered; current confirmation candidate pending; whole acceptance open; Engineering | U | U |
