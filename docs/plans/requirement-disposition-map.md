...
| IDA-DIA-002 | User-selected corridor | Canonical | unresolved | S5/S6; #1790 proves explicit guidance-country/no fallback; #1792 source `757aa623` captures origin/destination and zero-to-12 ordered transit values over `CountryCodeSchema`; persistence/packs/handoff open | open | Tracker receipt; source `757aa623` full proof and exact-main `e8142453` health passed; exact identities/hashes remain there unchanged. | U | U | U |
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; #1792 source `757aa623` preserves guidance/corridor query values across EN/SQ/MK/SR locale changes; pack/content and non-software readiness open | open | Tracker receipt; source full proof and exact-main `e8142453` health passed | U | U | U |
