...
| IDA-DIA-002 | User-selected corridor | Canonical | unresolved | S5/S6; #1790 proves explicit guidance-country/no fallback; #1792 source `757aa623` captures origin/destination and zero-to-12 ordered transit values over `CountryCodeSchema`; S5.e candidate discloses pack status from that explicit corridor only; persistence/handoff open | open | Tracker receipt; #1792 exact-main `e8142453` health passed; corrected S5.e exact-candidate proof and protected delivery pending. | U | U | U |
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; #1792 source `757aa623` proves in-app locale-switch query retention; S5.e mounts the same ordered status result on EN/SQ/MK/SR applied-corridor routes; pack/content and non-software readiness open | open | Tracker receipt; corrected exact-candidate E2E and protected delivery pending. | U | U | U |
| IDA-DIA-004 | Signed pack requirement | Canonical | unresolved | S5/S6; S5.e may disclose only the existing Help Now exposure predicate and cannot claim current/versioned/integrity/expiry readiness; full contract remains a later direct dependency | open | Existing fail-closed registry predicate credited; MOB-01b/MK receipt does not satisfy the signed/current/versioned/integrity/expiry contract; corrected S5.e exact-candidate proof remains pending. | U | U | U |
