...
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; #1792 source `757aa623` proves in-app locale-switch query retention; S5.e mounts the same ordered status result on EN/SQ/MK/SR applied-corridor routes; pack/content and non-software readiness open | open | Tracker receipt; corrected E2E tree `b6faaf72` proves full ordered direct-route locale disclosure; protected delivery pending. | U | U | U |
