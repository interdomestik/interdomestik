...
| IDA-MEM-006 | Provider confirmation | Target | unresolved | S6/S9; direct dependency for newly verified S5 first-case submission | open; verified provider event or reconciled authoritative transaction required; browser continuation grants no entitlement | none | U | U | U |
