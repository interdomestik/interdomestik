...
| IDA-DIA-002 | User-selected corridor | Canonical | unresolved | S5/S6; #1790 proves explicit guidance-country/no fallback; #1792 source `757aa623` captures origin/destination and zero-to-12 ordered transit values over `CountryCodeSchema`; S5.e source `05bcd02d` discloses pack status from that explicit corridor only; persistence/handoff open | open | Tracker receipt; #1792 exact-main `e8142453` health passed; S5.e source/tree/E2E tree `05bcd02d`/`88e68c1f`/`c96665e7` passed full local product and security proof; protected delivery pending. | U | U | U |
| IDA-DIA-003 | Locale independent from country pack | Canonical | unresolved | S5/S6; #1792 source `757aa623` proves in-app locale-switch query retention; S5.e mounts the same ordered status result on EN/SQ/MK/SR applied-corridor routes; pack/content and non-software readiness open | open | Tracker receipt; corrected E2E tree `00701d73` proves full ordered direct-route locale disclosure; protected delivery pending. | U | U | U |
| IDA-DIA-004 | Signed pack requirement | Canonical | unresolved | S5/S6; S5.e may disclose only the existing Help Now exposure predicate and cannot claim current/versioned/integrity/expiry readiness; full contract remains a later direct dependency | open | Existing fail-closed registry predicate credited; MOB-01b/MK receipt does not satisfy the signed/current/versioned/integrity/expiry contract; S5.e source `05bcd02d` passed bounded local disclosure proof only. | U | U | U |
| IDA-DIA-005 | Unsigned pack fail-closed | Canonical | unresolved | S5/S6; S5.e keeps dark, unaccepted, unsigned, duplicate and unregistered corridor entries unavailable without fallback; expired/withdrawn/integrity-failed contracts remain open | open | S5.e pure derivation proves fail-closed metadata cases; mounted proof uses the live registry. Full signed-pack acceptance and protected delivery remain pending. | U | U | U |
