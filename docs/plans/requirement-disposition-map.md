...
| IDA-MEM-006 | Provider confirmation | Target | unresolved | S6/S9; #1826 proves exact active Paddle status plus complete provider/member values and localized separate-case next steps; current delivery candidate binds the rendered request to immutable tenant/member/subscription/event evidence | open; verified provider event or reconciled authoritative transaction required; browser continuation and mail success grant no entitlement; whole activation remains open | none | bounded #1826 delivered; current delivery candidate pending; whole acceptance open; Engineering | U | U |
| IDA-MEM-007 | Idempotent activation | Canonical | unresolved | S6/S9; #1824 proves exact retry/dedupe before entitlement writes and #1826 preserves duplicate receipt short-circuiting; current delivery candidate adds authorized-to-ready CAS, isolated retry, provider-event-stable domain effects, a bounded stale receipt lease and provider idempotency key | open; generic/manual resend, offer/terms, live activation and whole acceptance remain unresolved | none | bounded #1824/#1826 delivered; current delivery candidate pending; whole acceptance open; Engineering | U | U |
