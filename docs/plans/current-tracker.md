...
| `V04` | `input:v0.1.0-production-background`; `risk:boundary-and-resilience`   | `pending` | `pending`                                       | `pending`        | `not_applicable` | `not_applicable` | `not_applicable` | `not_applicable` | `docs/plans/2026-03-06-v0-1-0-production-background-plan.md`; `packages/shared-utils/src/resilience.ts`; `apps/web/src/lib/actions/agent/register-member.core.ts`; `scripts/check-entrypoints-no-db.mjs`; `apps/web/src/app/[locale]/(agent)/agent/layout.tsx`; `docs/plans/current-tracker.md`                                                                     |
