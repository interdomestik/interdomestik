...
| `V03` | `input:v0.1.0-production-background`; `risk:member-data-remediation`   | `pending` | `pending`                                       | `pending`        | `not_applicable` | `not_applicable` | `not_applicable` | `not_applicable` | `docs/plans/2026-03-06-v0-1-0-production-background-plan.md`; `packages/database/src/scripts/backfill-members.ts`; `packages/database/src/member-number.ts`; `apps/web/src/lib/auth/hooks.ts`; `docs/plans/current-tracker.md`                                                                               |
