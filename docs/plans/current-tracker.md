...
| `S3-MEMBER-STAFF-SUPPORTED-PREFIX` | current program; IDA-CLM-001/014; IDA-CAS-005/006/007/008/015 | `gate-ks-sq` plus focused contracts | local  | isolated task DB | pending | local PostgreSQL 16 | `not_applicable` | pending  | Exact mounted UI journey passes with a fresh member return, exact member/agent/branch-manager denial, private-note exclusion and zero exact-row residue. Exact implementation head `f6acf6bd0b7ecf844480c1b62c484f11866849b4`, tree `645e0d0b2006985c9a7886f83991573150e57653` and E2E corpus tree `d7b9b1840181188e63c09fdf461b9672c8fe1126` passed `pr:verify`: 1,187 CI, 154 release, 41 RLS, 3,412 web/12 skips, 81.13% line coverage, 263 browser/13 skips and 13 smoke/11 skips; same-head `security:guard` passed. PostgreSQL-backed database contracts pass 323/323, including 10 relay contracts under a `Europe/Berlin` session; 19 focused status and 33 communications contracts pass, and the mounted neutral-host/S3 proof uses isolated port 3103. The protected-base status test is 794 lines/28,150 bytes; the candidate is 785/28,140, and the compressed legacy fixture exactly matches the protected-base SHA-256 `e9e3d69ecc2a5b41c18bfa6282356377e96da5ac082ed9c5b4456264b379dfea`. Sonnet 5 and Gemini reviews passed. The quota-reset Opus route reached provider-reported `claude-opus-5` with an allowed rate-limit event; its findings are corrected, with the final current-head resend pending. Protected delivery pending; IDA-CLM-010 remains open. |
