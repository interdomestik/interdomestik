...
| ---------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `S5-DIASPORA-CORRIDOR-PREPARATION` | `in_progress_bounded` | Codex | Capture explicit origin/destination/transit preparation context independent of UI language. | Owner approved +42,000 bytes/three new files before implementation. Candidate implements strict 20-code endpoints, zero-to-12 ordered transit values, exact repeated-query/locale preservation, accessible add/edit/remove and fail-closed parser boundaries on exact protected base `8db18b3`. Focused unit/type/i18n/modularity checks pass; mounted and full source-bound proof remain pending. Context remains non-authoritative; DIA-002/003 and pack/offline/S6/S7 work remain open. |
...
| ---------------------------------- | -------------------------------- | --------------------- | --------------- | -------- | --------------------- | ---------------- | ---------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `S5-DIASPORA-CORRIDOR-PREPARATION` | current program; S5; DIA-002/003 | `in_progress_bounded` | local candidate | pending  | partial focused proof | `not_applicable` | `not_applicable` | prep consultations complete | Owner approved +42,000 bytes/three new files before implementation. Domain 22/22 and web 18/18 focused tests, package type checks, i18n and modularity checks pass. Gemini and repaired Sonnet preparation consultations have recorded dispositions; the Mac comparison added no novel accepted case. A task-owned migrated/seed-asserted database and port 3179 were created, but the first mounted build stopped on host `ENOSPC` before tests; cleanup removed the database, released the port and deleted only generated `.next`. This is not mounted acceptance. Whole DIA-002/003, S5 and all pack/offline/handoff outcomes remain open. |
