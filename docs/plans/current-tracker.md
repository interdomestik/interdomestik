...
| -------------------------------- | ------------- | ---------- | ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `IDA-WF01-ONE-APPROVAL-DELIVERY` | `in_progress` | `platform` | Materialize B0 authority bootstrap | Exact approved artifacts and deterministic receipt merge from the admitted eight-path map; B0 exact-main health/CD containment/cleanup pass; external fsync ledger consumes B0 and activates only B1. |
