---
task_name: 'Membership-First Hero Redesign'
task_type: 'Feature'
priority: 'P1-High'
estimate: 'TBD'
test_level: 'unit'
roadmap_ref: ''
branch: 'main'
start_time: 'Sun Dec 21 00:08:04 CET 2025'
baseline:
  lint: 'pass'
  typecheck: 'pass'
  tests: 'pass'
  format: 'fail (exit 1)'
  log: '/Users/arbenlila/development/interdomestikv2/.agent/tasks/logs/qa_baseline_20251221_000748.log'
---

# 🚀 Current Task: Membership-First Hero Redesign
...
```xml
<task_definition>
  <objective>Membership-First Hero Redesign</objective>
  <type>Feature</type>
...
<user_story>
  As a visitor, I want to see Interdomestik as a Membership Protection Club first,
  so that I understand the value of joining before I even have a claim.
</user_story>
<acceptance_criteria>
  - [x] Hero title and subtitle focused on "Club Membership" value.
  - [x] Trust Strip includes membership-centric stats (e.g., Active Members, Hotline Response).
  - [x] Benefit points in the Hero include "Emergency Hotline" and "Damage Calculator".
  - [x] Call to action (CTA) clearly says "Join the Club" or "Become a Member".
</acceptance_criteria>
```
...
Membership-First Hero Redesign
