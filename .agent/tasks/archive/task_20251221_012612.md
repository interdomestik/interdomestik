---
task_name: "Brand Switch to Asistenca"
task_type: "Feature"
priority: "P1-High"
estimate: "TBD"
test_level: "unit"
roadmap_ref: ""
branch: "main"
start_time: "Sun Dec 21 01:09:34 CET 2025"
baseline:
  lint: "pass"
  typecheck: "pass"
  tests: "pass"
  format: "fail (exit 1)"
  log: "/Users/arbenlila/development/interdomestikv2/.agent/tasks/logs/qa_baseline_20251221_010921.log"
---

# 🚀 Current Task: Brand Switch to Asistenca
...
```xml
<task_definition>
  <objective>Brand Switch to Asistenca</objective>
  <type>Feature</type>
...
## 🔗 Related Files
Rebrand app from Interdomestik to Asistenca. Update: 1) common.appName to 'Asistenca', 2) Taglines to 'Pranë jush kur duhet' (SQ) / 'There when you need us' (EN), 3) Footer tagline from 'Protection Club' to new tagline, 4) Tier names to Asistenca (€20) / Asistenca+ (€35), 5) Card name to 'Karta Asistenca'. Keep company name 'Interdomestik' in legal/footer only.
