...
CREATE INDEX "support_handoffs_tenant_member_status_response_idx" ON "support_handoffs" USING btree ("tenant_id","member_id","status","public_response_at") WHERE "support_handoffs"."public_response" is not null;--> statement-breakpoint
