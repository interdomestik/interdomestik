...
ALTER TABLE "support_handoffs" ADD CONSTRAINT "support_handoffs_member_reply_length_check" CHECK ("support_handoffs"."member_reply" is null or char_length("support_handoffs"."member_reply") <= 1000) NOT VALID;
