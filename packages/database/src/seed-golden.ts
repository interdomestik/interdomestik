...
export async function seedGolden(config: SeedConfig) {
  ...
  const USERS = [
    ...
    {
      id: goldenId('pilot_prishtina_member_01'),
      name: 'Arta Krasniqi',
    ...
    {
      id: goldenId('pilot_prishtina_member_02'),
      name: 'Blerina Gashi',
      email: 'member.pilot.prishtina.02@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000002',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_03'),
      name: 'Donika Berisha',
      email: 'member.pilot.prishtina.03@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000003',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_04'),
      name: 'Elira Hoxha',
      email: 'member.pilot.prishtina.04@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000004',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_05'),
      name: 'Mimoza Shala',
      email: 'member.pilot.prishtina.05@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000005',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_06'),
      name: 'Altin Kelmendi',
      email: 'member.pilot.prishtina.06@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000006',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_07'),
      name: 'Besnik Rexhepi',
      email: 'member.pilot.prishtina.07@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000007',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_08'),
      name: 'Driton Ahmeti',
      email: 'member.pilot.prishtina.08@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000008',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_09'),
      name: 'Fisnik Bytyqi',
      email: 'member.pilot.prishtina.09@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000009',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('pilot_prishtina_member_10'),
      name: 'Luan Morina',
      email: 'member.pilot.prishtina.10@interdomestik.com',
      role: 'member' as const,
      tenantId: TENANTS.PILOT,
      branchId: 'pilot_branch_prishtina_central',
      memberNumber: 'PILOT-PR-000010',
      memberNumberIssuedAt: at(),
    },
    {
      id: goldenId('mk_bm_a'),
  ...
  const commercialAgreementsToSeed = [
    ...
    },
    {
      ...
      successFeeResolvedById: goldenId('ks_staff'),
      successFeeSubscriptionId: null,
      termsVersion: '2026-03-v1',
  ...
  ] satisfies Array<typeof schema.claimEscalationAgreements.$inferInsert>;

  for (const agreement of commercialAgreementsToSeed) {
    await db
